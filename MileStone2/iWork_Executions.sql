...
---- Number 4
 ...
 -- Deadline Did NOT Pass and Wasn't REVIEWED ie. Will be changed
EXEC ChangeTaskStatus 'Regular7', 'Number4Case1', 'Second Project'
 -- Deadline Did NOT Pass and Was REVIEWED ie. Will NOT be changed
EXEC ChangeTaskStatus 'Regular7', 'Number4Case2', 'Second Project'
 -- Deadline Passed ie. Will NOT be changed
...
---- Number 9
  -- Will be Assigned to the task as he working on the same project of the task
EXEC AssignTask 'YasmeenHRTestingAmr', '10th Task', 'Creating third new Project', 'Regular7'

  -- Will NOT be Assigned to the task as he working on the same project of the task
