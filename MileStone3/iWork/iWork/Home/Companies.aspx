<%@ Page Language="C#" Inherits="iWork.Home.Companies" enableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en" class=" "><head>
    ...
    <script type="text/javascript">
        $(function () {
            $('[id*=CompanyGridView]').prepend($("<thead></thead>").append($('[id*=CompanyGridView]').find("tr:first"))).DataTable({
                "responsive": true,
        ...
        <div class="right_col" role="main" style="min-height: 3820px;">
          <div class="">
            ...
            <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                <ItemTemplate>
                    <asp:Button runat="server" HeaderText="Select" id="SelectCompany" CommandArgument='<%# Container.DataItemIndex %>' OnCommand="SelectCompany_Clicked" Text="View Departments" type="submit" class="btn btn-success"></asp:Button>
                </ItemTemplate>
            </asp:TemplateField>
