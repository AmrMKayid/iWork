<%@ Page Language="C#" Inherits="iWork.Manager.Manager_Requests_Review" EnableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en">
  <head runat="server">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Requests <small>Dashboard</small></h3>
              </div>
            </div>
                          ...
                          <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <asp:TextBox ID="Reasontxt" runat="server" class="form-control input-lg" TextMode="MultiLine" MaxLength="1000"></asp:TextBox>                                       
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div >
                                <asp:Button runat="server" ID="AcceptRequest" Text="Accept Request" onclick="AcceptRequest_Clicked" type="submit" class="btn btn-info"></asp:Button>
								<asp:Button runat="server" ID="RejectRequest" Text="Reject Request" onclick="RejectRequest_Clicked" type="submit" class="btn btn-info"></asp:Button>
                              </div>
                            </div>
