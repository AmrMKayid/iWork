<%@ Page Language="C#" Inherits="iWork.Manager.Manager_Project_Task" EnableEventValidation="false"  %>
<!DOCTYPE html>
<html lang="en">
  <head runat="server">
  ...
  <body class="nav-md">
    <form id="TasksForm" runat="server">
                        ...
                        <div class="x_content">
                          <br>
                            ...
                            <div class="form-group">
                              ...
                              </label><span class="required">Deadline*</span>
