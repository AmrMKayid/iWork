<%@ Page Language="C#" Inherits="iWork.Manager.Manager_Requests" EnableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en">
  <head runat="server">
                    ...
                    <asp:GridView ID="RequestsGridView" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="There are no data records to display.">
                        <Columns>  
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                <ItemTemplate> 
                                    <asp:Button runat="server" id="TypeOfRequest" CommandArgument='<%#Eval("username")+","+ Eval("start_date")%>' OnClick="TypeOfRequest_Clicked" Text="Type" type="submit" class="btn btn-success"></asp:Button>    
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                <ItemTemplate> 
                                    <asp:Button runat="server" id="SelectRequest" CommandArgument='<%# Container.DataItemIndex %>' OnCommand="SelectRequest_Clicked" Text="Review" type="submit" class="btn btn-success"></asp:Button>    
                                </ItemTemplate>
                            </asp:TemplateField>
