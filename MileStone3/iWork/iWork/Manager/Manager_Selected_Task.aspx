<%@ Page Language="C#" Inherits="iWork.Manager.Profile.templates.Manager_Selected_Task" EnableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en">
  <head runat="server">
              ...
              <div class="col-md-12">
                ...
                <asp:GridView ID="RegEmpView" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="There are no data records to display.">
                    <Columns>
						...
						<asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                            <ItemTemplate>
                                <asp:Button runat="server" id="ReAssignToTask" CommandArgument='<%# Container.DataItemIndex %>' OnCommand="ReAssignToTask_Clicked" Text="Change Employee" type="submit" class="btn btn-success"></asp:Button>
                            </ItemTemplate>
                        </asp:TemplateField>
