<%@ Page Language="C#" Inherits="iWork.Job_Seeker.Job_seeker_interview" EnableEventValidation="false" AutoEventWireup="true"  %>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Interview Questions <small></small></h3>
              </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!-- start project list -->
                        <asp:GridView ID="Interview_GridView" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No jobs available for this search!">

                            <Columns>  
                              <asp:BoundField DataField="id" HeaderText="ID" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                                <asp:BoundField DataField="question" HeaderText="Questions" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                    ...
                    <asp:Button runat="server" id="Submit"   Text="Submit Application" type="submit" class="btn btn-success" OnClick="Submit_App"></asp:Button>    
