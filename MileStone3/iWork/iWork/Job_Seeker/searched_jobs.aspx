<%@ Page Language="C#" Inherits="iWork.Job_Seeker.searched_jobs" EnableEventValidation="false" AutoEventWireup="true" %>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div>
                        <asp:GridView ID="Searched_jobsGridView" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No jobs available for this search!">
                            ...
                            <Columns>  
                                ...
                                <asp:BoundField DataField="detailed_description" HeaderText="Details" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                    <ItemTemplate>
                                        <asp:Button runat="server" id="Apply"  CommandArgument='<%#Eval("title")+","+ Eval("department")+","+ Eval("company")%>'  OnClick="Apply_Clicked" Text="Apply" type="submit" class="btn btn-success"></asp:Button>    
                                    </ItemTemplate>
                                </asp:TemplateField>
