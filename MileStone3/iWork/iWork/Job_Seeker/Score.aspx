<%@ Page Language="C#" AutoEventWireup="true" Inherits="iWork.Job_Seeker.Score" EnableEventValidation="false"%>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Applicatio Score <small></small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                 ...
                 <span><p>You score is : <%:Session["Score"] %> </p></span>
                      <p>

                      </p>
                    <div class="bg-info text-white">To review this Application , Click on Application Status</div>
