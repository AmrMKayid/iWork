<%@ Page Language="C#" Inherits="iWork.Job_Seeker.Application_Status" EnableEventValidation="false" AutoEventWireup="true" %>
<!DOCTYPE html>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Application Status <small></small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p>PLease pick a day_off before clicking Get Hired! :</p>
                 <asp:DropDownList id="dayoff" runat="server">
                ...
                <asp:ListItem>Thursday</asp:ListItem>     
                      ...
                      <p>
                       ...
                       <asp:GridView ID="Applications" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Applications available for this search!">
                            ...
                            <Columns>  
                              <asp:BoundField DataField="company" HeaderText="Company" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                               ...
                               <asp:BoundField DataField="job_title" HeaderText="job_title" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                              <asp:BoundField  DataField="manager_status" HeaderText="Application_Status" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                              <asp:BoundField  DataField="score" HeaderText="Score" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                                  ...
                                  <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                    <ItemTemplate>
                                  <asp:Button runat="server"  ID="Delete_App"  Text="Delete" Enabled='<%# String.Equals((String)Eval("manager_status"),"pending",StringComparison.OrdinalIgnoreCase) %>' CommandArgument='<%#Eval("id")%>' onClick="delete_App" type="submit" Cssclass="btn btn-danger"></asp:Button>    
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                    <ItemTemplate>
                                  <asp:Button runat="server"  id="Choose_Job" Enabled='<%# String.Equals((String)Eval("manager_status"),"accepted",StringComparison.OrdinalIgnoreCase) %>' CommandArgument='<%#Eval("id") %>' onClick="Choose_App" Text="Get Hired!" type="submit" Cssclass="btn btn-success"></asp:Button>    
                       ...
                       <h4>*PS:Upon a successful hiring , you will get redirected to login page, to login as a Staff Member</h4>
