<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="iWork.Staff_Member.Dashboard.Index" EnableEventValidation="false" %>
...
<head>
    ...
    <title>Mission Control - iWork</title>
...
<body class="nav-md">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            ...
                            <asp:Panel ID="Manager_Tasks_Nav_Panel" runat="server">
                                <div class="menu_section">
    ...
    <div class="content hide">
        <div class="form-group">
           <input runat="server" id="fn" type="text" />
        </div>
    ...
    <div class="content hide">
        <div class="form-group">
           <input runat="server" id="mn" type="text" />
        </div>
    ...
    <div class="content hide">
        <div class="form-group">
           <input runat="server" id="ln" type="text" />
        </div>
    ...
    <div class="content hide">
        <div class="form-group">
           <input runat="server" id="pass" type="text" />
        </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="Index.aspx">Profile</a></li>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel id="NotStaffMember_Panel" runat="server">
                                    <div class="x_panel">
                                        <div class="x_content">
                                            
                                            <p>Sorry, you are not working in a company yet, or you are not logged in with your working account.</p>
                                            <br />
                                            
                                            <asp:Button id="LoginFirst_Button" runat="server" Text="Login" CssClass="btn" OnClick="LoginFirst_LinkButton_Click" />

                                        </div>
                                    </div>
                                </asp:Panel>

                                <asp:Panel id="MainContent_Panel" runat="server">
                                    <div class="x_panel">
