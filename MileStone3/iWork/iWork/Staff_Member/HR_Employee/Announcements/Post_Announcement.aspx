                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel id="PostAnnouncement_Panel" runat="server">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <table>
                                                <tr>
                                                    <td><asp:Label id="A_Type_Label" runat="server" Text="Type: " /></td>
                                                    <td><asp:TextBox id="A_Type_TextBox" runat="server" MaxLength="50" /></td>
                                                </tr>
                                                <tr>
                                                    <td><asp:Label id="A_Title_Label" runat="server" Text="Title: " /></td>
                                                    <td><asp:TextBox id="A_Title_TextBox" runat="server" MaxLength="50" /></td>
                                                </tr>
                                                <tr>
                                                    <td><asp:Label id="A_Desc_Label" runat="server" Text="Description: " /></td>
                                                    <td>
                                                ...
                                                <tr><td><br /></td></tr>
                                                <tr>
                                                    <td><asp:Button id="PostAnnouncement_Button" runat="server" CssClass="btn" Text="Post Announcement" OnClick="PostAnnouncement_Button_Click" /></td>
                                                    <td><asp:Label ID="PostStatusResult_Label" CssClass="status" runat="server" /></td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <asp:Panel id="NotHR_Panel" runat="server">
                                    <div class="x_panel">
                                        <div class="content">
                                            <p>Sorry, only HR Employees can post announcement to their companies.<br />
                                                If you are an HR Employee, please make sure that you are logged in with your working account.</p>
                                            <br />
                                            <asp:Button id="LoginFirst_Button" runat="server" CssClass="btn" Text="Login" OnClick="LoginFirst_Button_Click" />
                                        </div>
                                    </div>
                                </asp:Panel>
