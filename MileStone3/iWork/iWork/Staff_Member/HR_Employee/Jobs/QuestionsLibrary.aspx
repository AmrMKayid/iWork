                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel id="QuestionsLibrary_Panel" runat="server">
                                    
                                    <asp:Panel id="Questions_Panel" runat="server">
                                        <div class="x_panel">
                                            
                                            <div class="x_title">
                                                <h2>Interview Questions Library</h2>
                                                <div class="clearfix" />
                                            </div>
                                            
                                            <div class="x_content">
                                                <br />
                                                <asp:GridView id="Questions_GridView" runat="server" CssClass="dataTable" />
                                            </div>
                                    ...
                                    <asp:Panel id="AddQuestion_Panel" runat="server">
                                        <div class="x_panel">

                                            <div class="x_title">
                                                <h2>Add Question to the Library</h2>
                                                <div class="clearfix" />
                                            </div>
                                            ...
                                            <div class="x_content">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><asp:TextBox id="NewQuestion_TextBox" runat="server" MaxLength="100" /></td>
                                                        <td>
                                                            <asp:DropDownList id="AnswerNewQ_DropDownList" runat="server" CssClass="dropdown">
                                                                <asp:ListItem Text="True / Yes" Value="True" />
                                                                <asp:ListItem Text="False / No" Value="False" />
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td><asp:Button id="AddNewQ_Button" runat="server" CssClass="btn" Text="Add" OnClick="AddNewQ_Button_Click" /></td>
                                                    </tr>
                                                    <tr><asp:Label ID="AddNewQ_Status_Label" runat="server" /></tr>
                                                </table>
                                ...
                                <asp:Panel id="NotHR_Panel" runat="server">
                                    <div class="x_panel">
                                        <div class="x_content">
                                            <p>Sorry, this page is exclusively available for HR Employees for job creation and editing.<br />
