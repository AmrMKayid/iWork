                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile clearfix">
                            ...
                            <div class="profile_info">
                                <span>Welcome,</span>
                                <h2><asp:Label runat="server" id="usernameLbl" /></h2>
                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <asp:Label ID="usernameUpperRight_Label" runat="server" />
                                        <span class=" fa fa-angle-down"></span>
                                    </a>
                                    
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="../../Dashboard/Index.aspx">Profile</a></li>
                                        <li><asp:LinkButton ID="LogOut_LinkButton" runat="server" OnClick="LogOut_LinkButton_Click"><i class="fa fa-sign-out pull-right"></i>Log Out</asp:LinkButton></li>
                                    </ul>
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="page-title">
                            <div class="title_left"><h3>Dashboard</h3></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel id="EditJob_Panel" runat="server">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>Title:</td>
                                                    <td><asp:TextBox id="JobTitle_TextBox" runat="server" ReadOnly="true" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Working Hours:</td>
                                                    <td><asp:TextBox id="WorkingHours_TextBox" runat="server" TextMode="Number" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Salary:</td>
                                                    <td><asp:TextBox id="Salary_TextBox" runat="server" TextMode="Number" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Minimum Years of Experience:</td>
                                                    <td><asp:TextBox id="MinYearsOfXp_TextBox" runat="server" TextMode="Number" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Vacancy:</td>
                                                    <td><asp:TextBox id="Vacancy_TextBlock" runat="server" TextMode="Number" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Deadline:</td>
                                                    <td><asp:TextBox id="Deadline_TextBox" runat="server" TextMode="DateTime" /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Button ID="Save_Button" runat="server" CssClass="btn" OnClick="Save_Button_Click" Text="Save Changes" />
                                                    </td>
                                                    <td><asp:Label ID="UpdateJob_Status_Label" runat="server" CssClass="status" /></td>
                                                </tr>
                                            </table>
                                            ...
                                            <h3>Interview</h3>
                                            <asp:GridView id="JobQuestions_GridView" runat="server" CssClass="dataTable" OnRowCommand="JobQuestions_GridView_RowCommand" />
                                            ...
                                            <table>
                                                <tr>
                                                    <td><asp:DropDownList id="NewQuestion_DropDownList" CssClass="dropdown" runat="server" /></td>
                                                    <td><asp:Button id="AddQuestion_Button" runat="server" Text="Add" CssClass="btn" OnClick="AddQuestion_Button_Click" /></td>
                                                    <td><asp:Label ID="AddQuestion_Status_Label" runat="server" CssClass="status" /></td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="content">
                                            ...
                                            <asp:GridView id="Applications_GridView" runat="server" CssClass="table" OnRowCommand="Applications_GridView_RowCommand" />
                                            
                                            <asp:Label id="NoNewApplications_Label" runat="server" Text="No new applications..." />
                                ...
                                <asp:Panel id="NotHR_Panel" runat="server">
                                    <div class="x_panel">
                                        <div class ="x_content">
                                            <p>Sorry, only HR Employees can only edit jobs of their departments.<br />
                                                If you are an HR Employee, please make sure you are logged in with your working account.
                                            </p>
                                            <br />
