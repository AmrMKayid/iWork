                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel ID="ViewJobs_Panel" runat="server">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <asp:GridView id="Jobs_GridView" runat="server" CssClass="table" OnRowCommand="Jobs_GridView_RowCommand" />
                                        </div>
                                ...
                                <asp:Panel ID="NewJob_Panel" runat="server">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList id="JobRole_DropdownList" runat="server" CssClass="dropdown">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><asp:TextBox id="JobTitle_TextBox" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Button ID="Submit_Button" runat="server" CssClass="btn" OnClick="Submit_Button_Click" Text="Submit" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="SubmitJob_Status_Label" runat="server" CssClass="status" />
                                                    </td>
                                                </tr>
                                            </table>
