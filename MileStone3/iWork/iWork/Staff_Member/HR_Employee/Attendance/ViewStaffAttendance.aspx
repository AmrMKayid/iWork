                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel id="StaffMemberAttendance_Panel" runat="server">
                                    
                                    <asp:Label id="ChooseStaffMember_Label" runat="server" Text="Display attendance of: " />
                                    <asp:DropDownList id="ChooseStaffMember_DropDownList" runat="server" CssClass="dropdown" />
                                    <asp:Button id="ChooseStaffMember_Button" runat="server" CssClass="btn" Text="View" OnClick="ChooseStaffMember_Button_Click" />
                                    
                                    <br />
                                    <br />
                                    
                                    <asp:Panel id="AttendanceInRange" runat="server">
                                        <div class="x_panel">
                                            
                                            <div class="x_title">
                                                <h2>Attendance records in range</h2>
                                                <div class="clearfix" />
                                            </div>
                                            ...
                                            <div class="x_content">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><asp:Button runat="server" Text="View" CssClass="btn" OnClick="ChooseStaffMember_Button_Click" /></td>
                                                    </tr>
                                                </table>
                                            
                                                <br />
                                            
                                                <asp:Label ID="RangeError_Label" runat="server" CssClass="text-warning" />
                                                <br />

                                                <asp:GridView id="AttendanceInRange_GridView" runat="server" CssClass="table" />
                                    ...
                                    <asp:Panel id="AttendanceByMonth_Panel" runat="server">
                                        <div class="x_panel">

                                            <div class="x_title">
                                                <h2>Attended hours per month</h2>
                                                <div class="clearfix" />
                                            </div>
                                            ...
                                            <div class="x_content">
                                                ...
                                                <asp:GridView id="AttendanceOfYear_GridView" runat="server" CssClass="dataTable" />
                                ...
                                <asp:Panel id="NotHR_Panel" runat="server" CssClass="x_panel">
                                    <div class="x_panel">
                                        <div class="x_content">
                                            <p>Sorry, this page is accessible only the HR Employees.<br />
                                                If you are an HR Employee, please make sure you are logged in to your working account.
                                            </p>
                                            <br />
