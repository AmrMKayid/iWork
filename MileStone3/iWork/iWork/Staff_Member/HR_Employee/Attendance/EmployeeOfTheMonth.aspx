...
<head>
    ...
    <title>Top Employees - iWork</title>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel id="TopEmployees_Panel" runat="server">
                                    <div class="x_panel">
                                    
                                        <div class="x_title">
                                            <h2>Top 3 Regular Employees of the Month</h2>
                                            <div class="clearfix" />
                                        </div>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>Month: </td>
                                                    <td>
                                                        <asp:DropDownList id="Month_DropDownList" runat="server" CssClass="dropdown">
                                                    ...
                                                    <td><asp:TextBox id="Year_TextBox" runat="server" TextMode="Number" CssClass="yearselect" /></td>
                                                    <td><asp:Button id="View_Button" runat="server" Text="View" CssClass="btn" OnClick="View_Button_Click" /></td>
                                                </tr>
                                            </table>
            
                                            <br />
                                            
                                            <asp:GridView id="TopAchievers_GridView" runat="server" CssClass="table" />
                                            
                                            <br />
                                            
                                            <asp:Button id="Congratulate_Button" runat="server" Text="Congratulate" CssClass="btn" Visible="false" OnClick="Congratulate_Button_Click" />
                                            <asp:Label ID="CongratulationsSent_Status_Label" runat="server" CssClass="status" />
