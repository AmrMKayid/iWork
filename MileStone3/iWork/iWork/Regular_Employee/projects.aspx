<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false"  Inherits="iWork.Regular_Employee.projects" %>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Assigned Project <small></small></h3>
              </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                       ...
                       <asp:GridView ID="Projects" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Applications available for this search!">
                            ...
                            <Columns>  
                              ...
                              <asp:BoundField   DataField="end_date" HeaderText="Deadline" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                            
                                 

                                <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                    <ItemTemplate>
                                  <asp:Button runat="server"  id="view_Tasks" CommandArgument='<%# Eval("name")%>' OnClick="Show_Tasks" Text="Tasks" type="submit" Cssclass="btn btn-success"></asp:Button>    
