<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="iWork.Regular_Employee.Tasks" %>
                  ...
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="../Default.aspx">Main</a></li>
                        <li><a href="Regular_Employee.aspx">Profile</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                <h3>[Regular_Employee]</h3>
                <ul class="nav side-menu">


                   <li><a><i class="fa fa-pencil"></i> Projects <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li> <asp:LinkButton ID="LinkButton2" runat="server" OnClick="View_projects">View Projects</asp:LinkButton></li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Assgined Tasks <small></small></h3>
              </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                       ...
                       <asp:GridView ID="tasks" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Applications available for this search!">
                            ...
                            <Columns>  
                              ...
                              <asp:BoundField  DataField="deadline" HeaderText="Deadline" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"/>  
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                    <ItemTemplate>
                                  <asp:Button runat="server" ID="Fix"  Text="Fix Task" Enabled='<%# String.Equals((String)Eval("Status"),"Assigned",StringComparison.OrdinalIgnoreCase) && Convert.ToDateTime(Eval("deadline"))>= DateTime.Now %>' CommandArgument='<%# Eval("name")%>' OnClick="fix" type="submit" Cssclass="btn btn-success"></asp:Button>    
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                  <ItemTemplate>
                                <asp:Button runat="server" ID="comment"  Text="Comments"  CommandArgument='<%#Eval("name")+","+ Eval("company")+","+ Eval("project")%>' OnClick="View_comments" type="submit" Cssclass="btn btn-info"></asp:Button>    
