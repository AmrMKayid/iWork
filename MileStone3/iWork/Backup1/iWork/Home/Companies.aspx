<%@ Page Language="C#" Inherits="iWork.Home.Companies" %>
<!DOCTYPE html>
        ...
        <div class="right_col" role="main" style="min-height: 3820px;">
          <div class="">
            ...
            <asp:TemplateField HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                <ItemTemplate>
                    <asp:Button runat="server" HeaderText="Select" id="SelectCompany" CommandArgument='<%# Container.DataItemIndex %>' OnCommand="SelectCompany_Clicked" Text="Select" type="submit" class="btn btn-success"></asp:Button>
                </ItemTemplate>
            </asp:TemplateField>
